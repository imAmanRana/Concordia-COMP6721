...
class ModelTrainer :
    ...
    def dt_max_depth(self):
        ...
        f = open("results_dt_ds2_maxDepth.txt", "a+")
        f.write('max_depth'+ ','+ 'accuracy_training'+ ','+ 'accuracy_validation');
        for max_depth in maximum_depths:
            ...
            f.write(str(max_depth)+","+str(accuracy_training)+","+str(accuracy_validation)+"\n");
        f.flush()
        f.close()
    ...
    def dt_min_sample_split(self):
        ...
        f = open("results_dt_ds2_minSampleSplit.txt", "a+")
        f.write('min_samples_split' + ',' + 'accuracy_training' + ',' + 'accuracy_validation')
        ...
        for min_samples_split in min_samples_splits:
            ...
            accuracy_validation = accuracy_score(self.validation_labels, validation_predicted) * 100
            print(min_samples_split, ',', accuracy_training, ',', accuracy_validation);
            f.write(str(min_samples_split) + "," + str(accuracy_training) + "," + str(accuracy_validation) + "\n");
        f.flush()
        f.close()
    ...
    def dt_min_sample_leaf(self):
        ...
        f = open("results_dt_ds2_minSampleLeaf.txt", "a+")
        f.write('min_samples_leaf' + ',' + 'accuracy_training' + ',' + 'accuracy_validation')
        ...
        for min_samples_leaf in min_samples_leafs:
            ...
            print(min_samples_leaf , ',', accuracy_training, ',',
                  accuracy_validation);
            f.write(str(min_samples_leaf) + "," + str(accuracy_training) + "," + str(accuracy_validation) + "\n");
    ...
    def dt_max_features(self):
        ...
        f = open("results_dt_ds2_MaxFeatures.txt", "a+")
        f.write('max features' + ',' + 'accuracy_training' + ',' + 'accuracy_validation\n')
        ...
        for max_feature in max_features:
            ...
            f.write(str(max_feature) + "," + str(accuracy_training) + "," + str(accuracy_validation) + "\n");
        f.flush()
        f.close()
    ...
    def train_using_dt(self):
        classifier = tree.DecisionTreeClassifier(min_samples_leaf=6)
        ...
        with open(MODEL2.MODEL_DT, 'w') as file:
    ...
    def train_using_nb(self):
        ...
        with open(MODEL2.MODEL_NB, 'wb') as file:
            pickle.dump(classifier, file);
    ...
    def train_using_svm(self):
        ...
        with open(MODEL1.MODEL_SVM, 'wb') as file:
            pickle.dump(classifier, file);
